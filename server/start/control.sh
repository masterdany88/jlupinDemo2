...
eval "${JLUPIN_JAVA_EXE} -Dconsole.upload.dir=${SCRIPT_PATH}/../upload -Dcontrol.log_path=${SCRIPT_PATH}/../logs/control/control.log -Dcontrol.history_file_path=${SCRIPT_PATH}/control/control.history -Dcontrol.log_level=INFO -Dcontrol.address="127.0.0.1" -Dcontrol.port="9096" -Dcontrol.connectionTimeout="1000" -Dcontrol.readTimeout="60000" -jar ${SCRIPT_PATH}/control/control.jar ${ARGS}"
